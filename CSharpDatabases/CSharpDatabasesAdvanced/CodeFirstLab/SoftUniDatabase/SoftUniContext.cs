...
namespace SoftUniDatabase
{
    ...
    public partial class SoftUniContext : DbContext
    {
        ...
        public IEnumerable<ProjectInfo> GetProjectsByEmployee(string firstName, string lastName)
        {
            ...
            return this.Database.SqlQuery<ProjectInfo>("udp_GetEmployeeProjects @firstName, @lastName", firstNameParam, lastNameParam);

        }

        public IEnumerable<EmployeesModel> GetMaxSalaries()
        {

            return this.Database.SqlQuery<EmployeesModel>("udp_GetSalariesInformation");
