...
using System.Text;
using _02.AdvancedMapping.DTOs;
        ...
        static void Main()
        {
            ...
            AutoMapper.Mapper.Initialize(cfg =>
            {
                ...
                cfg.CreateMap<Employee, ManagerDTO>()
                    .ForMember(dest => dest.Count, opt => opt.MapFrom(src => src.EmployeesHeIsInCharge.Count));
            });
        ...
        private static IEnumerable<Employee> CreateManagers()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                var manager = new Employee()
                {
                    ...
                    EmployeesHeIsInCharge = new List<Employee>(),
                    IsOnHoliday = false,
                ...
                manager.EmployeesHeIsInCharge.Add(employee1);
                manager.EmployeesHeIsInCharge.Add(employee2);
                manager.EmployeesHeIsInCharge.Add(employee3);
